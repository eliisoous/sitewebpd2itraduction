...
class Header {
    ...
    getTranslations() {
        return {
            ...
            FR: {
                home: 'Accueil',
                coatingEquipments: 'Équipements',
                coatingCompact: 'Équipements',
                ...
                edgePreparation: 'Prep. arêtes',
                edgePrepCompact: 'Prep. arêtes',
                greenClean: 'Green Clean',
                plasmaNitriding: 'Nitruration',
                plasmaCompact: 'Nitruration',
                services: 'Services',
                news: 'Actualités',
                aboutUs: 'À propos',
